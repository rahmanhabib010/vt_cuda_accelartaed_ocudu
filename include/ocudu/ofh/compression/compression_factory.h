...
/// \param[in] impl_type  Request for a specific implementation type ("auto", "enabled", "disabled", "avx2",
///                       "avx512", "neon", "generic", "cuda"). "auto" selects CUDA when available, otherwise the
