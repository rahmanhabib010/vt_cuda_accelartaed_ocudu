...
///
/// It assumes 164 resource elements for a maximum of 275 PRB, four layers and eight bits per RE. This covers PUSCH
/// Type-2 DM-RS allocations with one DM-RS symbol.
constexpr unsigned MAX_NOF_SEGMENTS = (164 * 275 * 4 * 8) / MAX_SEG_LENGTH.value();
