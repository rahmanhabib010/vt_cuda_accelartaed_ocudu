...
private:
  ...
  /// Maps host-generated reference signals before any PDSCH data device-grid writes.
  bool map_reference_signals();

  /// Creates reference signal tasks for host-only grids.
  void fork_reference_signal_tasks();
