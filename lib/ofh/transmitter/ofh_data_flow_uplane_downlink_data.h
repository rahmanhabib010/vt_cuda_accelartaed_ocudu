...
public:
  ...
  /// Enqueues User-Plane downlink data messages for contiguous resource-grid ports.
  virtual void enqueue_section_type_1_messages(const data_flow_uplane_resource_grid_context& base_context,
                                               unsigned                                      first_port,
